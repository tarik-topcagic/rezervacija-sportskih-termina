...
namespace SportskiTerminiAPI.Migrations
{
    ...
    [Migration("20260721103533_AddMessageDeleteReplyReactionsPin")]
    partial class AddMessageDeleteReplyReactionsPin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportskiTerminiAPI.Models.GroupMessageReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportskiTerminiAPI.Models.PrivateMessageReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportskiTerminiAPI.Models.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportskiTerminiAPI.Models.GroupMessage", b =>
                {
                    ...
                    b.HasOne("SportskiTerminiAPI.Models.GroupMessage", "ReplyToMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("SportskiTerminiAPI.Models.PrivateMessage", b =>
                {
                    ...
                    b.HasOne("SportskiTerminiAPI.Models.PrivateMessage", "ReplyToMessage")
                        .WithMany()
                        .HasForeignKey("ReplyToMessageId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("SportskiTerminiAPI.Models.PrivateMessageReaction", b =>
                {
                    b.HasOne("SportskiTerminiAPI.Models.PrivateMessage", "PrivateMessage")
                        .WithMany("Reactions")
